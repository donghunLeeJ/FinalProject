                        ...
                        <div class="col-lg-12 ">
                           <div class="row mt-2">
                              <div
                                 ...
                                 <img id="food0" class="img" src="/img/default.jpg"
                                    style="height: 100%" alt="">
                              </div>
                              <div style="text-align: center; height: 5em"
                                 class="d-none d-sm-block border col-lg-4 col-md-4 col-sm-4 p-0">
                                 <img id="food1" class="img" src="/img/default.jpg"
                                    style="height: 100%" alt="">
                              </div>
                              <div style="text-align: center; height: 5em"
                                 class="d-none d-sm-block border col-lg-4 col-md-4 col-sm-4 p-0">
                                 <img id="food2" class="img" src="/img/default.jpg"
                                    style="height: 100%" alt="">
                              </div>
                           </div>
                        </div>
   ...
   <script>
      ...
      $("#submitbtn").on(
            ...
            function() {
               ...
               if (inputcount > 0) {
               ...
               } else if ($("#contents").val().length > 500) {
                  alert("가능한 내용 길이를 초과하였습니다");
               } else if ($("#shop_location").val()=="지역 선택") {
                  alert("지역을 선택해주세요");
                  $("#shop_location").click();
                  ...
                  removeXSS($("#material").val(), $("#material").attr(
                        "id"));
