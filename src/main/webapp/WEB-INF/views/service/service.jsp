					...
					<div class="single-booking-table d-flex">
						<div class="card mb-3">
							...
							<div class="card-body">
								...
								<p class="card-text">
									버려지는 음식이 많은건 알고 있었지만...개인이 구하긴 어렵잖아요~ <br>저희가 대신 구해 드릴께요!
									사장님~ 그거 우리한테 파세요!!!
								</p>
							</div>
						</div>
					...
					<div class="single-booking-table d-flex">
						<div class="card mb-3">
							...
							<div class="card-body">
								...
								<p class="card-text">
									우리 솔직해 지자구요~맛있는 음식을 이렇게 싸게 먹을 수 있잖아요!<br>게다가 몰랐던 맛집을 찾을 수도
									있구요! <br>사장님~ 버리지말구 돈 조금이라도 받고 파세요. 이것도 고객 유치라구요!
								</p>
							</div>
						</div>
					</div>
	...
	<div class="container">
			...
			<div class="col-12 col-lg-6" >
				...
				<div class="our-certificate-area mb-60 d-flex align-items-center">
					<img src="/img/core-img/certificate-1.png" alt=""> <img
						src="/img/core-img/certificate-2.png" alt=""> <img
	...
	<div class="container">
		<div class="row" >
			...
			<div class="col-12 col-sm-6 col-lg-3">
				<div class="single-team-member mb-80">
					<div class="team-member-img">
						<img src="/img/service-img/kapjoongprofile.jpg" alt=""
							style="height: 243px">
						<!-- Social Info -->
						<div
							class="team-social-info d-flex align-items-center justify-content-center">
			...
			<div class="col-12 col-sm-6 col-lg-3">
				<div class="single-team-member mb-80">
					<div class="team-member-img">
						<img src="/img/service-img/hanuelprofile.jpg" alt="" style="height: 243px">
						<!-- Social Info -->
						<div
							class="team-social-info d-flex align-items-center justify-content-center">
							<div class="social-link">
