<%@ page language="java" contentType="text/html; charset=EUC-KR"
	...
	<!-- Header Area Start -->
	<header class="header-area"> <!-- Top Header Area Start -->
	...
	<!-- Top Header Area End --> <!-- Main Header Start -->
	<div class="main-header-area">
		<div class="classy-nav-container breakpoint-off">
			<div class="container">
				...
				<!-- Logo --> <a class="nav-brand" href="index.html"><img
					src="/img/core-img/logo.png" alt=""></a> <!-- Navbar Toggler -->
